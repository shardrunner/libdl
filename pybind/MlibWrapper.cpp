...
PYBIND11_MODULE(MlibWrapper, m) {
  ...
  py::class_<NeuralNetwork>(m, "NeuralNetwork")
      ...
      .def("test_network", &NeuralNetwork::test_network,
      ...
      .def("get_current_prediction", &NeuralNetwork::get_current_prediction,
           py::return_value_policy::reference)
      .def("layer_size", &NeuralNetwork::layer_size,
           py::call_guard<py::scoped_ostream_redirect,
                          py::scoped_estream_redirect>())
      .def("get_predicted_classes",
           &NeuralNetwork::get_predicted_classes); //,py::arg().noconvert();
}