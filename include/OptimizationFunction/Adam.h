 ...
 *
 * To achieve this, it stores the values from the last update step and uses them in combination with some hyperparameter.
...
public:
    /**
     * Constructor
     * @param filter_height The height of the filter which the optimizer updates. Used for storing the history.
     * @param filter_width The width of the filter which the optimizer updates. Used for storing the history.
     * @param bias_size The bias size which the optimizer updates. Used for storing the history.
     */
