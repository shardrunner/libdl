...
public:
    /**
     * Calculates the loss for the given input x an label y using binary cross entropy loss.
  ...
  /**
   * Calculates the derivative of the binary cross entropy loss with the given input x and labels y.
