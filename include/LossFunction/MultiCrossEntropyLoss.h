...
public:
  /**
   * Calculates the loss for the given input x an label y using multiclass cross
   * entropy loss.
   * @param a_prev Feed forward input from the previous layer.
   * @param label Corresponding labels as column Vector with 0..#classes per
   * sample/row.
  ...
  /**
   * Calculates the derivative of the multiclass cross entropy loss with the
   * given input x and labels y. Stores it internally.
   * @param a_prev Feed forward input from the previous layer.
   * @param label Corresponding labels as column vector with 0..#classes per
   * sample/row.
   */
